...
h1. Checking in a customer

h2. Checkin

Resource: @GET /api/v1/checkin@
...
@curl -v -X POST -H "Content-Type: application/json" --data "{\"api_token\": \"test\", \"customer\": {\"name\": \"Wessss\", \"card_number\": \"1118004661178\", \"device_token\": \"ABC123\"}}" http://scanner.144.38.23.210.xip.io/api/v1/customers@
